...
private val colorMap = Map(
  ...
  "dimgrey" -> new Color(0x69, 0x69, 0x69, 0xff),
  "gray" -> new Color(0x80, 0x80, 0x80, 0xff),
  "darkgray" -> new Color(0xa9, 0xa9, 0xa9, 0xff),
  "lightgray" -> new Color(0xd3, 0xd3, 0xd3, 0xff),
  "slategray" -> new Color(0x70, 0x80, 0x90, 0xff),
  "lightslategray" -> new Color(0x77, 0x88, 0x99, 0xff),
  "darkslategray" -> new Color(0x2f, 0x4f, 0x4f, 0xff),
