...
/** Font-free tests for the Telugu cluster front end: character categorization, cluster segmentation and base
  ...
  *
  * Telugu differs from the other Indic scripts texish sets in two ways these tests pin down: nothing
  * reorders, because no vowel sign is drawn before its consonant; and the base of a conjunct is its *first*
  * consonant, the joined ones hanging beneath it as subscripts.
  */
